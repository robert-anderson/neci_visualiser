...
line='''
    ...
    <path
       style="fill:none;fill-rule:evenodd;stroke:{d[colour]};stroke-width:{d[width]}px;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1"
       d="m {d[x]},{d[y]} {d[dx]}, {d[dy]}"
       id="{d[id]}"
